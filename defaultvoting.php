...
function fun1() {
    var x = 'sandy%20masori'
	//alert(x);
    var CuURL = 'http://localhost/Master/Algos/defaultvoting.php?target=' +  x;
...
function fun3() {
	...
	//alert(y);
 	var CuURL3 = document.URL+'&count=' + 4;
...
function fun5()
	{
		window.location = 'http://localhost/Master/Algos/defaultvoting.php';
	}
	</script>
</html>