...
//START SESSION
//session_start();
include('imported/item_to_item.php');
?>
...
<link rel="stylesheet" type="text/css" href="../styles/general.css">
	...
	<br><br><<br>
<H1> Item-To-Item Based CF / KNN </H1>
<body>
...
function usersfun() {
	...
	//alert(x);
    var CuURL = 'http://localhost/Master/Algos/iti.php?target=' +  x;
...
function fun5()
	{
		window.location = 'http://localhost/Master/Algos/iti.php';
	}
	</script>
</html>